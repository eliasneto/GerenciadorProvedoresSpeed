...
def inicializar_sistema():
    ...
    while tempo_limite > 0:
        try:
            ...
            print("⏱️ Banco de dados ainda iniciando. Tentando novamente em 2 segundos...")
            time.sleep(2)
            tempo_limite -= 2
    else:
    ...
    if not User.objects.filter(username=admin_username).exists():
        print(f"⚙️ Criando superusuário '{admin_username}'...")
        ...
        print(f"⚠️ O administrador '{admin_username}' já existe no banco. Pulando criação.")
