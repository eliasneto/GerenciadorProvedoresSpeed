...
urlpatterns = [
    ...
    path('empresa/<int:pk>/editar/', views.lead_empresa_update, name='lead_empresa_update'),
    path('empresa/<int:pk>/enderecos/novo/', views.lead_empresa_endereco_create, name='lead_empresa_endereco_create'),
    path('empresa/<int:empresa_pk>/enderecos/<int:pk>/editar/', views.lead_empresa_endereco_update, name='lead_empresa_endereco_update'),
